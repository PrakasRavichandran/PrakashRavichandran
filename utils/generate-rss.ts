...
export default async function generateRss(): Promise<void> {
  const site_url = `${process.env.SITE_URL || "https://prakashravichandran.vercel.app"}`;
  ...
  const author = {
    ...
    link: "https://prakashravichandran.vercel.app",
  };

  const feedOptions = {
    title: "RSS Feed - Prakash Ravichandran",
    description: "Prakash Ravichandran's personal blog",
    id: site_url,
    link: site_url,
