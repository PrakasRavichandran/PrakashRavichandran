  ...
  return (
    <div className="mt-10">
      ...
      <p className="mt-2 text-base text-zinc-600 dark:text-zinc-400 mb-4">
        ...
        <Link
          href="https://github.com/PrakasRavichandran/PrakashRavichandran/discussions/"
          target="blank"
        >
      ...
      <Giscus
        id="comments"
        repo="PrakasRavichandran/PrakashRavichandran"
        repoId=""
        category="General"
        categoryId=""
        mapping="pathname"
      ...
      <p className="mt-2 text-base text-zinc-600 dark:text-zinc-400">
        ...
        <Link
          href="https://github.com/PrakasRavichandran/PrakashRavichandran/discussions?discussions"
          target="blank"
        >
